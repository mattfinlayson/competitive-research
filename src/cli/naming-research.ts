...
function generateCandidateAnalysis(name: string): CandidateResult {
  ...
  return {
    ...
    confidence,
    rationale: `${name} shows ${confidence} potential with aggregate score of ${aggregateScore.toFixed(2)}. ` +
